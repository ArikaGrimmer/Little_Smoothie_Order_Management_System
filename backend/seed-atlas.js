// Quick script to seed menu items to MongoDB Atlas
// Run with: node seed-atlas.js
...
async function seedDatabase() {
  ...
  try {
    ...
    // Insert new items
    const insertResult = await collection.insertMany(smoothieItems);
    console.log(`✅ Successfully inserted ${insertResult.insertedCount} menu items!`);
    ...
    console.log('   Collection: menu_items (8 documents)');
